...
#define EM_AF_GENERATED_NETWORK_STRINGS  \
  "Primary (pro)", \
/**** ZCL Section ****/
#define ZA_PROMPT "Project_ZB_Router_Zone_2"
...
#define EMBER_AF_BASIC_CLUSTER_SERVER_ENDPOINT_COUNT (10)
#define EMBER_AF_IDENTIFY_CLUSTER_CLIENT_ENDPOINT_COUNT (10)
#define EMBER_AF_IDENTIFY_CLUSTER_SERVER_ENDPOINT_COUNT (10)
...
#define EMBER_AF_TEMP_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (2)
...
#define EMBER_AF_PRINT_TEMP_MEASUREMENT_CLUSTER 0x0140
